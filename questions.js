const quizData = [
  ...
  },
  {
    ...
    "options": [
      ...
      "TCP 是可靠的傳輸協定",
      "UDP 適合用於需要高度準確性的資料傳輸"
    ],
    "answer": "D",
    "analysis": "UDP 為不可靠傳輸，不保證資料到達，適合即時性（如串流）而非高度準確性要求的資料。"
  },
  {
    "id": "L4010014",
    ...
    "options": [
      "PPP 允許雙方進行協商以確定不同選項",
      "PPP 僅能用於非同步傳輸",
      "PPP 可以與各種不同的網路協定互相整合",
      "PPP 不支援驗證功能"
    ],
    "answer": "AC",
    "analysis": "PPP 具有協商能力且能整合多種協定（如 IP, IPX 等）。"
  },
  {
    "id": "L4010015",
  ...
  },
  {
    ...
    "options": [
      ...
      "sudo systemctl kill systemd-networkd",
      "sudo systemctl remove systemd-networkd"
    ],
    "answer": "B",
  ...
  },
  {
    ...
    "answer": "BD",
    "analysis": "路由表紀錄目的地 (Destination)、閘道 (Gateway)、遮罩 (Genmask) 以及輸出的網卡介面 (Iface)。"
  },
  {
    "id": "L4010055",
  ...
  },
  {
    ...
    "options": [
      ...
      "scp 可以利用 -",
      "scp 可以利用 -4 參數指定使用 IPv4 連線"
    ],
    "answer": "ACD",
    "analysis": "scp 基於 SSH，使用的是 Port 22。"
  },
  {
    "id": "L4010058",
  ...
  },
  {
    ...
    "options": [
      ...
      "ssh u1@server runOnce 表示在遠端執行 runOnce 指令",
      "SSH 使用 Port 22，Telnet 使用 23"
    ],
    "answer": "ACD",
  ...
  },
  {
    ...
    "answer": "D",
    "analysis": "TCP Wrapper 並無 cache 機制，Client 連線時會即時讀取設定檔，故存檔即生效。"
  },
  {
    "id": "L4010063",
    ...
    "options": [
      ...
      "rsync 可以保留同步檔案的擁有者、群組與權限屬性",
      "rsync 不支援連結檔與設備檔（devices）的同步"
    ],
    "answer": "D",
  ...
  },
  {
    ...
    "answer": "ABC",
    "analysis": "SFTP 因為需要加解密運算，速度通常比傳統明文的 FTP 慢。"
  },
  {
    "id": "L4010065",
  ...
  },
  {
    ...
    "answer": "B",
    "analysis": "(A)設定服務請求網卡、組態設定檔路徑等。(B)為核心組態檔。(C)為DHCP伺服器執行腳本。"
  },
  {
    "id": "L4020003",
  ...
  },
  {
    ...
    "answer": "A",
    "analysis": "(A)為租約紀錄檔的正解路徑。(B)不存在。(C)是執行檔。"
  },
  {
    "id": "L4020010",
  ...
  },
  {
    ...
    "answer": "A",
    "analysis": "/etc/exports 是 NFS 的核心設定檔。(B)(C)無此檔案，(D)為核心支援的檔案系統資訊。"
  },
  {
    "id": "L4020019",
  ...
  },
  {
    ...
    "answer": "C",
    "analysis": "root_squash 參數會將遠端的 root (uid 0) 權限壓制為匿名使用者，防止 root 擁有一切權限。"
  },
  {
    "id": "L4020021",
    ...
    "answer": "A",
    "analysis": "all_squash 會將「所有」用戶端的使用者 uid 都對應成匿名者 (nobody)。"
  },
  {
    "id": "L4020022",
    ...
    "answer": "B",
    "analysis": "sync 代表同步寫入，確保資料完成寫入磁碟後才回應成功；async 則是不等待直接回應。"
  },
  {
    "id": "L4020023",
  ...
  },
  {
    ...
    "answer": "D",
    "analysis": "Samba 的核心設定檔路徑固定為 /etc/samba/smb.conf。"
  },
  {
    "id": "L4020032",
  ...
  },
  {
    ...
    "answer": "A",
    "analysis": "testparm 是 Samba 內建的語法檢查工具，可確認 smb.conf 設定是否正確。"
  },
  {
    "id": "L4020034",
  ...
  },
  {
    ...
    "answer": "A",
    "analysis": "invalid users 用於設定禁止登入的黑名單。"
  },
  {
    "id": "L4020038",
    ...
    "answer": "B",
    "analysis": "smbclient 使用大寫 -U 指定使用者，格式為「使用者%密碼」。-L 是列出分享清單，而非登入資源。"
  },
  {
    "id": "L4020039",
